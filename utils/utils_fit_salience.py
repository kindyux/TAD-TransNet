...
def fit_one_epoch_salience(model, yolo_loss, salience_loss, optimizer, epoch, epoch_step, gen, Epoch, cuda, save_dir,
    ...
    with tqdm(total=epoch_step, desc=f'Epoch {epoch + 1}/{Epoch}', postfix=dict, mininterval=0.3) as pbar:
        for iteration, batch in enumerate(gen):
            ...
            loss_value = 1 * loss_value_all + 1 * salience_loss_value
    ...
    path = "/root/autodl-tmp/yolo/dataset/sirst-master/test.txt"
    img_root = '/root/autodl-tmp/yolo/dataset/sirst-master/JPEGImages/'
    png_root = '/root/autodl-tmp/yolo/dataset/sirst-master/masks/'
